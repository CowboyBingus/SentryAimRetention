...
with zipfile.ZipFile(sys.argv[1]) as z:
    ...
    assert manager['Name']=='Sentry Aim Retention - v1.0.9' and len(manager['Options'])==1
    ...
    assert p['revision']=='data-v8.2' and p['runtime_verified'] is False
    assert p['version']=='1.0.9' and p['status']=='release'
